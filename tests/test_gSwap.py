...
class TestGSwap(TestCase):
    ...
    def test_swap(self):
        ...
        for source, text in sample_texts.iteritems():
    ...
    def test_contexts_performed(self):
        ...
        contexts = {
            u'It is a truth universally acknowledged, that a single man in possession of a good fortune must be in want of a wife': [
                {'source': u'man', 'flip': 'woman'}, {'source': u'wife', 'flip': 'husband'}],
            u' I am a man of substance, of flesh and bone, fiber and liquids-and I might even be said to possess a mind': [
                {'source': u'man', 'flip': 'woman'}],
            u' He was lying on his hard, as it were armor-plated, back and when he lifted his head a little he could see his dome-like brown belly divided into stiff arched segments on top of which the bed quilt could hardly keep in position and was about to slide off completely': [
                {'source': u'He', 'flip': 'She'}, {'source': u'his', 'flip': 'her'}, {'source': u'he', 'flip': 'she'},
                {'source': u'his', 'flip': 'her'}, {'source': u'he', 'flip': 'she'}, {'source': u'his', 'flip': 'her'}],
            u" First reports of him came to me through Chad King, who'd shown me a few letters from him written in a New Mexico reform school": [
                {'source': u'him', 'flip': 'her'}, {'source': u'King', 'flip': 'Queen'},
                {'source': u'him', 'flip': 'her'}],
            u' Then news came that Dean was out of reform school and was coming to New York for the first time; also there was talk that he had just married a girl called Marylou': [
                {'source': u'he', 'flip': 'she'}, {'source': u'girl', 'flip': 'boy'}],
            u' Dean is the perfect guy for the road because he actually was born on the road, when his parents were passing through Salt Lake City in 1926, in a jalopy, on their way to Los Angeles': [
                {'source': u'guy', 'flip': 'gal'}, {'source': u'he', 'flip': 'she'}, {'source': u'his', 'flip': 'her'}],
            u'I am an invisible man': [{'source': u'man', 'flip': 'woman'}],
            u' This is all far back, when Dean was not the way he is today, when he was a young jailkid shrouded in mystery': [
                {'source': u'he', 'flip': 'she'}, {'source': u'he', 'flip': 'she'}],
            u'I first met Dean not long after my wife and I split up': [{'source': u'wife', 'flip': 'husband'}],
            u'As Gregor Samsa awoke one morning from uneasy dreams he found himself transformed in his bed into a gigantic insect': [
                {'source': u'he', 'flip': 'she'}, {'source': u'himself', 'flip': 'herself'},
                {'source': u'his', 'flip': 'her'}],
            u' I was tremendously interested in the letters because they so naively and sweetly asked Chad to teach him all about Nietzsche and all the wonderful intellectual things that Chad knew': [
                {'source': u'him', 'flip': 'her'}],
            u' However little known the feelings or views of such a man may be on his first entering a neighbourhood, this truth is so well fixed in the minds of the surrounding families, that he is considered as the rightful property of some one or other of their daughters': [
                {'source': u'man', 'flip': 'woman'}, {'source': u'his', 'flip': 'her'},
                {'source': u'he', 'flip': 'she'}, {'source': u'daughters', 'flip': 'sons'}],
            u' His numerous legs, which were pitifully thin compared to the rest of his bulk, waved helplessly before his eyes': [
                {'source': u'His', 'flip': 'Her'}, {'source': u'his', 'flip': 'her'},
                {'source': u'his', 'flip': 'her'}]}
